...
I am a first-year PhD candidate at the HKUST NLP Group, Hong Kong University of Science and Technology (HKUST), supervised by Prof. Junxian He. I graduated from Shanghai Jiao Tong University (SJTU) in June 2024, where I was also previously advised by Prof. Junxian He during my undergraduate studies.
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**
   **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*, 2025. (First author; code available on GitHub: Vision4Chart.)

3. **On the Universal Truthfulness Hyperplane Inside LLMs**
   **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author; code available on GitHub: Universal_Truthfulness_Hyperplane.)
